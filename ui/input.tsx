	...
	return (
		<span
			...
			className={clsx([
				...
				// Only apply these styles for non-file inputs
				type !== "file" && [
		...
		>
			<Headless.Input
				...
				className={clsx([
					// Date classes
					type &&
						dateTypes?.includes(type as DateType) && [
					...
					// Different padding for file type
					type === "file"
						? "file:mr-4 file:py-2 file:px-4 file:rounded-lg file:rounded-l-none file:border-0 file:text-sm file:font-semibold file:bg-zinc-50 file:text-zinc-700 hover:file:bg-zinc-100 dark:file:bg-zinc-700 dark:file:text-zinc-100 dark:hover:file:bg-zinc-600"
